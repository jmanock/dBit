...
exports.leaderboard = function(req, res){
  request({uri:'http://www.pgatour.com/data/r/current/leaderboard.json', json:true},function(error, response, body){
...
exports.tournamentSetup = function(req, res){
  Tournament.findOne({}).sort({modified:-1}).exec(function(err, setupRecord){
    if(err || !setupRecord){
...
exports.getField = function(req, res){
  Player.find({},{'name':1, 'id':1}).exec(function(err, players){
    if(err || !players){
...
exports.getScorecard = function(req, res){
  ...
  Player.findOne({id:playerId}).exec(function(err, playerRecord){
