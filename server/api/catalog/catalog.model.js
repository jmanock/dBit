...
// With this catalog model, we can not only add nested categories,
// but also keep track of the categories' ancestors and children.
// Also, adds a plugin to generate the slugs based on the name.
